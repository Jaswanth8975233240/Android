var authenticator = (function () {
  ...
  function createInstance() {
    ...
    return {
      ...
      // looks for buttons and registers onclick listeners
      parseSite: function () {
        ...
        instance.registerSignOutButton(signOutButton);

        var disconnectButton = document.getElementById("switchAccountButton");
        instance.registerDisconnectButton(disconnectButton);
      },
      ...
      // adds onclick event listener to a passed DOM element
      registerSignOutButton: function (div) {
        if (div != null) {
          //log("Registering sign out button: " + div.id);
          div.onclick = instance.signOutFromGoogle;
        }
      },

      // adds onclick event listener to a passed DOM element
      registerDisconnectButton: function (div) {
        if (div != null) {
          //log("Registering disconnect button: " + div.id);
          div.onclick = instance.disconnectFromGoogle;
        }
      }
